...
@Component({
  selector: 'app-lista-cirugias-doctor',
  templateUrl: './lista-cirugias-doctor.component.html',
  styleUrls: ['./lista-cirugias-doctor.component.css']
})
export class ListaCirugiasDoctorComponent {
